    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Groups
                        <div class="page-title-subheading">Show details for group <i>{{ $group->name }}</i>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-inline-block dropdown">
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="/groups/{{ $group->id }}/delete" class="nav-link" onclick="return confirm_delete()">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Details</h5>
                <form method="POST" action="{{ route('group.update', $group->id) }}" class='{!! ($errors->any()) ? "was-validated" : "needs-validation" !!}'>
                    @csrf
                    @method('PUT')
                    <div class="position-relative row mb-3"><label for="name" class="form-label col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                            <input name="name" id="name" type="text" class="form-control" value="{{ $group->name }}">
                            @error('name')
                    ...
                    <div class="position-relative row mb-3"><label for="name" class="form-label col-sm-2 col-form-label">Tourist tax</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input name="tourist_tax" id="tourist_tax" type="number" step="any" value="{{ $group->tourist_tax }}" class="form-control">
                            </div>
                            @error('tourist_tax')
                                <div class="invalid-feedback">
                                    {{ $message }}
